...
@Config
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOPpostautonom", group = "TEST")

public class TeleOPpostautonom extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            double powerRight = returnPower(targetPosition, 1985 /*lift.liftRight.getCurrentPosition()*/,Kp,0,0);
            double powerLeft = returnPower(targetPosition, 1985/*lift.liftLeft.getCurrentPosition()*/,Kp,0,0);
