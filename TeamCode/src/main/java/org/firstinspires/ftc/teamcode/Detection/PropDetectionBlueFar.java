...
public class PropDetectionBlueFar implements VisionProcessor {
    ...
    public static int leftRectX1 = 400, leftRectY1 = 370;         // 450, 350
    public static int leftRectX2 = 600, leftRectY2 = 470;           // 550, 450

    public static double rightThresh = 400000;     //500000
    public double rightSum = 0;

    public static int middleRectX1 = 820, middleRectY1 =420;         // 820, 420
    public static int middleRectX2 = 920, middleRectY2 = 520;        // 920, 520
