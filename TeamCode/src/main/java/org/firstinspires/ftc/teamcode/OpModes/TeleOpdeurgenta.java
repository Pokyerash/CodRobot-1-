...
@Config
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOpdeurgenta", group = "TEST")

public class TeleOpdeurgenta extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            double powerRight = returnPower(targetPosition, 0,Kp,0,0);
            double powerLeft = returnPower(targetPosition, 0,Kp,0,0);
            ...
            if(gamepad2.right_stick_button) {
                intake.intakeUAD.setPosition(0.275);
            }
            ...
            if(gamepad2.a && retractrequest==false){
                lift.servoL.setPosition(0.77);
                lift.servoR.setPosition(0.77);
                retractrequest=true;
            }
            ...
            if(gamepad2.right_trigger>0) {
                ...
                intake.intakeUAD.setPosition(0.345);   //0.42
            }
            ...
            if(gamepad1.dpad_down){
                ...
                airplane.AirplaneUAD.setPosition(0.255);
            }
            ...
            if(gamepad2.dpad_down){
                lift.rotation.setPosition(0.477);
            }
            ...
            if(gamepad2.right_bumper){
                intake.intakeUAD.setPosition(0.1875);
            }

            if(gamepad2.left_bumper){
                intake.intakeUAD.setPosition(0.22);
            }
            if(gamepad2.right_stick_button){
                intake.intakeUAD.setPosition(0.26);
            }
          ...
          /*  public void loop() {
                if(gamepad1.a) {
                    double currentPosition = lift.rotation.getPosition();
                    double newPosition = currentPosition + 0.025;
                    newPosition = Math.min(newPosition, 1.0);
                    lift.rotation.setPosition(newPosition);
                    sleep(200);
                }
            }
